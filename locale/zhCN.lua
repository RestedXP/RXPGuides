...
L["Maximize Nameplate Distance"] = "最大化名条距离"
L["Automatically maximize nameplate visibility distance for better target detection (Requires reload)"] = "自动最大化名条可见距离以更好地检测目标 (需要重新加载)"
