...
L["This guide delivers the fastest path from level 1 to 70 for every class and zone. Optimized for minimal downtime, it includes the best quest routes, grinding spots, and dungeon segments to reach max level quickly and efficiently."] = "本指南为所有职业和区域提供从 1 级到 70 级的最快升级路线。通过最小化空档时间进行优化，包含最佳任务路线、刷怪点以及地下城流程，帮助你快速高效地达到满级。"
L["Select Survival Guide"] = "选择生存向指南"
L["This guide delivers the safest path from level 1 to 70 for every class and zone. Optimized for maximum survivability it includes the best quest routes, grinding spots, and dungeon segments to reach max level safely and efficiently."] = "本指南为所有职业和区域提供从 1 级到 70 级的最安全升级路线。以最大生存能力为优化目标，包含最佳任务路线、刷怪点以及地下城流程，帮助你安全且高效地达到满级。"
