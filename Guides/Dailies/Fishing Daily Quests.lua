...
step
	...
	.daily 13830,13832,13833,13834,13836, >> Talk to |cRXP_FRIENDLY_Marcia Chase|r in Dalaran. She has 1 out of 5 daily Fishing quests. Accept whichever is available
	>>The Ghostfish -- 13830
...
step
	...
	.isOnQuest 13834
step << Alliance
	>>Fish anywhere in Wintergrasp for |cRXP_LOOT_Terrorfish|r
...
step << Horde
	...
	.isOnQuest 13834
step
	>>Talk to |cRXP_FRIENDLY_Marcia Chase|r in Dalaran
	.goto Dalaran,53.04,64.95
...
step
	#completewith next
	>>Remember to buy baubles to use on your fishing rod
	.fly River's Heart >>Talk to |cRXP_FRIENDLY_Aludane|r to fly to Sholazar Basin
...
step
	#completewith next
	>>Fish for the |cRXP_LOOT_Phantom Ghostfish|r in River's Heart
	.goto SholazarBasin,49.40,62.13
	.collect 45902,1 --Phantom Ghostfish (1)
	.isOnQuest 13830
step
	.use 45902 >>Eat the |cRXP_LOOT_Phantom Ghostfish|r in your bags
...
step
	>>Remember to buy baubles to use on your fishing rod
	>>Go down into the Dalaran Sewers. Fish for the |cRXP_LOOT_Corroded Jewelry|r
...
step
	>>Remember to buy baubles to use on your fishing rod
	>>Fish for the |cRXP_LOOT_Bloated Slippery Eel|r outside of The Violet Hold in Dalaran
	.goto Dalaran,62.16,67.18
	.collect 45328,1 -- Bloated Slippery Eel (1)
	.isOnQuest 13836
step
	.use 45328 >>Open the |cRXP_LOOT_Bloated Slippery Eel|r in your bags and loot the |cRXP_LOOT_Severed Arm|r
	.complete 13836,1 --Severed Arm (1)
	.isOnQuest 13836
step
	>>Talk to |cRXP_FRIENDLY_Olisarra the Kind|r in Dalaran
...
step << Alliance
	#completewith next
	>>Remember to buy baubles to use on your fishing rod
	.fly Une'pe >>Talk to |cRXP_FRIENDLY_Aludane|r to fly to Une'pe, Borean Tundra
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13833
	.target Aludane
step << Horde
	#completewith next
	>>Remember to buy baubles to use on your fishing rod
	.fly Taunka'le >>Talk to |cRXP_FRIENDLY_Aludane|r to fly to Taunka'le, Borean Tundra
	.goto Dalaran,72.18,45.78,20,0
	.isOnQuest 13833
	.target Aludane
step
...
step -- WIP. Currently no check for debuff. If they get debuff @ first WP then it will point to the next 2 WP's before pointing to the sea to start fishing
	>>Kill any |cRXP_ENEMY_animal|r in Borean Tundra to receive the [Animal Blood] debuff on you
	>>Jump into water to remove the debuff, which will create a |cRXP_PICK_Pool of Blood|r
	.goto BoreanTundra,75.56,42.01,60,0
	>>Fish |cRXP_LOOT_Bloodtooth Frenzys|r from this |cRXP_PICK_Pool of Blood|r
