...
step << Warrior
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Ander Germaine|r upstairs
...
step << Warrior
    .goto Stormwind City,78.211,47.596
    >>Talk to |cRXP_FRIENDLY_Ander Germaine|r and train a spell
...
step << Paladin
    .goto Stormwind City,37.142,33.266
    >>Talk to |cRXP_FRIENDLY_Lord Grayson Shadowbreaker|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target Lord Grayson Shadowbreaker
step << Paladin
    .goto Stormwind City,37.142,33.266
...
step << Rogue
    .goto Stormwind City,78.326,57.038
    >>Talk to |cRXP_FRIENDLY_Lord Tony Romano|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target Lord Tony Romano
step << Rogue
    .goto Stormwind City,78.326,57.038
...
step << Priest
    .goto Stormwind City,38.572,26.005
    >>Talk to |cRXP_FRIENDLY_High Priestess Laurena|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target High Priestess Laurena
step << Priest
    .goto Stormwind City,38.572,26.005
...
step << Mage
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Jennea Cannon|r in the Mage Tower
    .turnin 64028 >>Turn in A New Beginning
    .accept 64031 >>Accept Tools for Survival
...
step << Mage
    .goto Stormwind City,38.528,79.328
    >>Talk to |cRXP_FRIENDLY_Jennea Cannon|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target Jennea Cannon
step << Mage
    .goto Stormwind City,38.528,79.328
...
step << Warlock
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Ursula Deline|r in the Slaughtered Lamb
    .turnin 64028 >>Turn in A New Beginning
    .accept 64031 >>Accept Tools for Survival
...
step << Warlock
    .goto Stormwind City,26.116,77.200
    >>Talk to |cRXP_FRIENDLY_Ursula Deline|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target Ursula Deline
step << Warlock
    .goto Stormwind City,26.116,77.200
...
step << Hunter
    .goto Stormwind City,61.576,15.188
    >>Talk to |cRXP_FRIENDLY_Einris Brightspear|r and train a spell
    .complete 64034,1 -- Train a Spell (1)
    .target Einris Brightspear
step << Hunter
    .goto Stormwind City,61.576,15.188
