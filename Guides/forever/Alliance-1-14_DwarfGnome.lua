...
#season 2
#completewith next
    .goto 1426/0,479.72,-6498.17,20 >> Enter the troll cave
step << Warlock
#loop
#season 2
    #label Feathers
...
step << Rogue
    #season 2
    .goto 1426/0,-545.07,-5574.76,5,0
    .goto Dun Morogh,47.160,52.335,5,0
    .goto 1426/0,-508.58,-5584.25
...
step << Warrior
    ...
    .goto 1426/0,-246.72,-5315.18,60,0
    .goto 1426/0,-276.27,-5026.25
    .mob Frostmane Headhunter
    .mob Frostmane Snowstrider
    .mob Frostmane Seer
    .train 403475,1
...
step << Paladin
    #season 2
    #completewith next
    .goto 1455/0,-1279.20,-4956.82,10,0
    .goto 1455/0,-1287.03,-4975.18,10 >>Travel toward |cRXP_FRIENDLY_Bruuk Barleybeard|r inside the Inn
    .train 425621,1
step << Paladin
    #season 2
    .goto 1455/0,-1287.03,-4975.18
...
step << Paladin
    #season 2
    #completewith next
    .goto 1453/0,878.35,-8545.61,5,0
    .goto 1453/0,871.9,-8539.69,5,0
    .goto 1453/0,890.04,-8571.69,8,0
    .goto 1453/0,889.64,-8578.68,8,0
    .goto 1453/0,897.71,-8584.06,8,0
    .goto 1453/0,904.29,-8574.92,8,0
    .goto 1453/0,897.71,-8561.56,8,0
    .goto 1453/0,913.3,-8541.57,8,0
    .goto 1453/0,928.09,-8544.98,8,0
    .goto 1453/0,943.14,-8525.26,8,0
    .goto 1453/0,931.85,-8508.41,8,0
    >>Go downstairs into the western side of the Cathedral's Crypt
    .goto 1453/0,939.24,-8500.88,8 >>Travel toward the |cRXP_LOOT_Charred Note|r in the crypt
    .train 410015,1
step << Paladin
    #season 2
    .goto 1453/0,939.24,-8501.77
...
step << Paladin
    ...
    #completewith next
    #label Island
    .goto 1431/0,716.42,-10225.35,50 >>Travel toward |cRXP_FRIENDLY_Ada Gelhardt|r on the island
    .train 410015,1
    .itemcount 205864,1 --Charred Note (1)
step << Paladin
    #season 2
    #completewith next
    .goto 1431/0,716.42,-10225.35
