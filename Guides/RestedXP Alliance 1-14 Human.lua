...
step << Warlock tbc
    ...
    >> Talk to |cRXP_FRIENDLY_ Dane Winslow|r
    .vendor >> Vendor trash
    .target Dane Winslow
step << Warlock tbc
    .goto Elwynn Forest,49.873,42.649
    >> Talk to |cRXP_FRIENDLY_ Drusilla La Salle|r
...
step
    ...
    >> Talk to |cRXP_FRIENDLY_ Deputy Willem|r
...
step << Priest tbc/Mage tbc/Warlock tbc
    ...
    .vendor >>Kill |cRXP_LOOT_Wolves|r until 50c worth of vendor trash. Vendor, then buy x10 water from |cRXP_FRIENDLY_ Brother Danil|r.
    .target Brother Danil
...
step << Priest/Mage
    ...
    .xp 2 >> Grind to 2
step
    >> Talk to |cRXP_FRIENDLY_ Eagan Peltskinner|r outside the Abbey
...
step
    .goto Elwynn Forest,48.9,40.2
    >> Return to |cRXP_FRIENDLY_ Eagan Peltskinner|r
    .target Eagan Peltskinner
...
step << Priest tbc/Mage tbc/Warlock tbc
    ...
    .vendor >>Vendor trash, then buy x10 more water from |cRXP_FRIENDLY_ Brother Danil|r.
    .target Brother Danil
    .collect 159,10 --Collect Refreshing Spring Water (x10)
...
step << Mage
    >> Talk to |cRXP_FRIENDLY_ Khelden Bremen|r
...
step << Priest
    >> Talk to |cRXP_FRIENDLY_ Priestess Anetta|r
...
step << Warrior
    ...
    .trainer >> Train your class spells
step << Paladin
    >> Talk to |cRXP_FRIENDLY_ Brother Sammuel|r
...
step
#xprate >1.69
    >> Speak with |cRXP_FRIENDLY_ Milly Osworth|r
...
step << Rogue
    >> Speak with |cRXP_FRIENDLY_ Jorik Kerridan|r
...
step
#xprate <1.7
    >> Talk to |cRXP_FRIENDLY_ Brother Neals|r
...
step
    >> Leave Northshire Valley and talk to |cRXP_FRIENDLY_ Falkhaan Isenstrider|r
    .target Falkhaan Isenstrider
    .goto Elwynn Forest,45.6,47.7
    .accept 2158 >> Accept Rest and Relaxation
step
    #hardcore
    >> Talk to |cRXP_FRIENDLY_ Marshall Dughan|r
...
step << Mage/Priest/Warlock
    #completewith next
    >> Talk to |cRXP_FRIENDLY_ Andrew Krighton|r
...
step
    ...
    .accept 62 >> Accept The Fargodeep Mine
step
    >>On your close left as you go in the Inn talk to |cRXP_FRIENDLY_ William Pestle|r
...
step
    .xp 6 >> Grind to 6
step << Rogue
    >> Talk to |cRXP_FRIENDLY_ Brog Hamfist|r
    .target Brog Hamfist
...
step << Warlock
    >> Talk to |cRXP_FRIENDLY_ Maximillian Crowe|r and |cRXP_FRIENDLY_ Cylina Darkheart|r
...
step << Priest
    .goto Elwynn Forest,43.283,65.721
>>Talk to |cRXP_FRIENDLY_ Priestess Josetta|r
...
step << Rogue
    .money <0.01
    >> Talk to |cRXP_FRIENDLY_ Keryn Sylvius|r
    .target Keryn Sylvius
    .goto Elwynn Forest,43.9,65.9
    .trainer >> Train your class spells
step << Rogue/Warrior
    .money <0.01
    >> Talk to |cRXP_FRIENDLY_ Michelle Belle|r
...
step << Warrior
    ...
    .trainer >> Train your class spells
step << Paladin
    >> Talk to |cRXP_FRIENDLY_ Brother Wilhelm|r
    .target Brother Wilhelm
    .goto Elwynn Forest,41.1,66.0
    .trainer >> Train your class spells
step
    >> Speak with |cRXP_FRIENDLY_ Remy "Two Times"|r
    .target Remy "Two Times"
    .goto Elwynn Forest,42.1,67.3
    .accept 47 >> Accept Gold Dust Exchange
step << Priest
    >>Use Lesser Heal Rank 2 and then Power Word: Fortitude on |cRXP_FRIENDLY_ Guard Roberts|r
...
step
    >> Talk to |cRXP_FRIENDLY_ Ma Stonefield|r and |cRXP_FRIENDLY_ "Auntie" Bernice Stonefield|r
...
step << Priest/Mage/Warlock
    #label Dust
    >>Grind mobs east and talk to |cRXP_FRIENDLY_ Billy Maclure|r
...
step
    #label BoarMeat1
    >> Talk to |cRXP_FRIENDLY_ Maybell Maclure|r in the small house
...
step << Mage tbc/Priest tbc/Warlock tbc
    ...
    >> Talk to |cRXP_FRIENDLY_ Joshua Maclure|r
...
step
    ...
    .collect 769,4 --Collect Chunk of Boar Meat (x4)
step
    >> Head back to the Stonefield farm, then keep going to the river. Talk to |cRXP_FRIENDLY_ Tommy Joe Stonefield|r
...
step
    >> Speak with |cRXP_FRIENDLY_ Gramma Stonefield|r inside the house
...
step
    ...
    .complete 60,1 --Collect Kobold Candle (x8)
step
    >>Grind mobs east through the outside of the mine and talk to |cRXP_FRIENDLY_ Billy Maclure|r on the farm
    .target Billy Maclure
    .goto Elwynn Forest,43.132,85.722
...
>>Talk to |cRXP_FRIENDLY_ Supervisor Raelen|r
...
>>Talk to |cRXP_FRIENDLY_ Sara Timberlain|r
...
>>Talk to |cRXP_FRIENDLY_ Farmer Saldean|r
-->>Talk to |cRXP_FRIENDLY_ Farmer Furlbrow|r
-->>Talk to |cRXP_FRIENDLY_ Marshal Dughan|r
--
-->>Talk to |cRXP_FRIENDLY_ Marshal Haggard|r
-->>Talk to |cRXP_FRIENDLY_ Deputy Rainer|r
...
>>Talk to |cRXP_FRIENDLY_ Verner Osgood|r
-->>Talk to |cRXP_FRIENDLY_ Smith Argus|r
...
step << Warlock
    ...
    .goto Elwynn Forest,44.4,66.2
.target Remen Marcot
>>Talk to |cRXP_FRIENDLY_ Remen Marcot|r
...
step
    ...
    .goto Elwynn Forest,43.2,89.6
.target Maybell Maclure
>>Talk to |cRXP_FRIENDLY_ Maybell Maclure|r
...
>>Talk to |cRXP_FRIENDLY_ Quartermaster Lewis|r
...
>>Talk to |cRXP_FRIENDLY_ Osric Strang|r
...
>>Talk to |cRXP_FRIENDLY_ Wizbang Cranktoggle|r
    .accept 983 >> Accept Buzzbox 827
step
    .maxlevel 13
    >> Accept quests around Auberdine
.target Tharnariun Treetender
>>Talk to |cRXP_FRIENDLY_ Tharnariun Treetender|r
...
>>Talk to |cRXP_FRIENDLY_ Gwennyth Bly'Leggonde|r
