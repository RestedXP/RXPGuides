...
step
    .xp 5+2295 >>Grind to 2295+/2800xp
step
...
step << Hunter
    #sticky
    #completewith Ambercorn
    >>Collect the 'Acorn' looking items on the ground, below the trees
    .goto Mulgore,49.3,56.2,10
    .goto Mulgore,52.0,61.1,10
    .goto Mulgore,50.0,66.4,10
    .goto Mulgore,50.4,66.5,10
step << !Hunter
    #sticky
    #completewith Ambercorn
    >>Collect the 'Acorn' looking items on the ground, below the trees
...
.goto Mulgore,55.9,63.1,60
    .goto Mulgore,51.1,66.5,60
    .goto Mulgore,40.7,73.0,60
step << Tauren
...
step
    #completewith Gnolls
    >>Be aware of Snagglespear (level 9 rare). He hits very hard and nets. Don’t pull him
step
    #sticky
#completewith Gnolls
    .goto Mulgore,53.5,73.0,60
    .goto Mulgore,48.3,72.0,60
step
    #label Gnolls
#requires Stones
    >>Go back and forth between the two camps, killing Gnolls
...
.goto Mulgore,51.1,58.6,30    
    .goto Mulgore,59.7,62.5,30
step
...
.complete 766,1 --Prairie Wolf Heart (1)
    ...
    .complete 766,4 --Swoop Gizzard (1)
step
    >>Kill Dwarf mobs for Prospector’s Picks. Use them on the Forge until you’ve broken 5
.goto Mulgore,31.3,49.9
    .complete 746,1 --Broken Tools (5)
step
    >>Kill Harpies for their Talons
...
step << Tauren Warrior/Tauren Shaman
    >>Kill Wolves in the area for teeth
...
step
    >>Run into The Barrens
.goto Mulgore,69.6,60.4,100
step << Druid/Hunter
...
step
    #label Spores
>>Loot the white mushrooms around the pool. Be careful of high level mobs
...
step
    #sticky
    #completewith next
.goto Mulgore,31.7,28.2,40
    .goto Mulgore,30.2,19.5,40
step
...
.goto Mulgore,52.6,12.2,40
    .goto Mulgore,48.6,16.1,40
    .goto Mulgore,51.8,33.8,40
    .goto Mulgore,56.2,32.9,40
step
    .goto Mulgore,52.6,12.2
