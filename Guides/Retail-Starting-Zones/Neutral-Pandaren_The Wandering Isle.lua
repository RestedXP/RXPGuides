...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Master Shang Xi|r
...
step << Hunter
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWeapon Rack|r for the |T537025:0|t[Trainee's Crossbow].
...
step << Mage
    .isOnQuest 30033
    .goto 378,57.22,19.22
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWeapon Rack|r for the |T537771:0|t[Trainee's Spellblade] and |T654237:0|t[Trainee's Hand Fan].
...
step << Monk/Priest
    .isOnQuest 30027
    .goto 378,57.22,19.22
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWeapon Rack|r for the |T537770:0|t[Trainee's Staff].
...
step << Shaman
    .isOnQuest 30037
    .goto 378,57.22,19.22
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWeapon Rack|r for the |T537205:0|t[Trainee's Axe] and |T537769:0|t[Trainee's Shield].
...
step << Rogue
    .isOnQuest 30036
    .goto 378,57.22,19.22
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWeapon Rack|r for the |T537767:0|t[Trainee's Daggers].
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFBanner|r to burn it.
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Merchant Lorvo|r
...
step
    #completewith next
    >>Kill |cFFFF5722Amberleaf Scamps|r and loot them for their |T132622:0|t|cFF00BCD4Supplies.|r
...
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Merchant Lorvo|r and |cFF00FF25Aysa Cloudsinger.|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Ji Firepaw|r
...
step
    #completewith Fluttering Breeze
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFRoots|r
...
step
    ...
    >>Kill the |cFFFF5722Living Air|r and loot him for the |T463565:0|t|cRXP_LOOT_Fluttering Breeze.|r
...
step
    ...
    .complete 29418,1 --5/5 Dry Dogwood Root
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Ji Firepaw|r and |cFF00FF25Shang Xi.|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Master Li Fei.|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFBrazier.|r
    .complete 29664,1 --1/1 Challenger Torch lit
 step
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFBraziers.|r
...
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Jojo Ironbrow|r and |cFF00FF25Aysa Cloudsinger.|r
...
step
	...
	.vehicle >> Click a |cFF00FF25Balance Pole|r while you are not in the water.
step
    #completewith Shrine
	>>Defeat the |cFFFF5722Tushui Monks|r on the poles.
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Old Man Liang|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFAncient Clam|r |cFFfa9602underwater.|r
    >>|cFFFCDC00You don't need to kill|r |cFFFF5722Fang-she.|r
...
step
    .goto 378,79.82,39.31
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Aysa Cloudsinger|r
...
step
	...
	>>|cFFFCDC00Disregard the|r |cRXP_FRIENDLY_Delivery Cart|r; |cRXP_WARN_traveling on foot will get you to your destination faster.|r 
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Ji Firepaw|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Gao Summerdraft|r
    .accept 29770 >>Accept Still Good!
	.target Gao Summerdraft
step
	#completewith Carrots
    >>Kill |cFFFF5722Plump Virmens|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFTurnips|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFPumpkin|r
...
step
    ...
    >>Kill |cFFFF5722Plump Carrotcatchers|r and loot them for their |cFF00BCD4Carrots|r. You can also |TInterface/cursor/crosshair/interact.blp:20|tclick the |cFFDB2EEFCarrots|r on the ground.
...
step
	...
	.mob Plump Virmen
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Gao Summerdraft|r, |cFF00FF25Ji Firepaw|r, and |cFF00FF25Jojo Ironbrow|r
...
step
	#completewith next
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWood Planks|r
    .complete 29771,1 --12/12 Discarded Wood Plank
step
    .goto 378,62.63,77.05
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFMallet|r |cFFfa9602on the barrel.|r
...
step
	...
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFWood Planks|r |cFFfa9602on the floor.|r
    .complete 29771,1 --12/12 Discarded Wood Plank
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Jojo Ironbrow|r and |cFF00FF25Ji Firepaw|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Elder Shaopai|r and |cFF00FF25Jojo Ironbrow.|r
...
step
    #completewith Defaced Scroll of Wisdom burned
    >>Kill |cFFFF5722Fe-Feng Wisemans|r and loot them for their |cFF00BCD4Brushes.|r
    .complete 29777,1 --8/8 Paint Soaked Brush
	.mob Fe-Feng Wiseman
step
    #completewith Defaced Scroll of Wisdom burned
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFStone Blocks.|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFBanners|r on the monuments.
...
step
	...
	.mob Fe-Feng Wiseman
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Elder Shaopai|r, |cFF00FF25Jojo Ironbrow|r, and |cFF00FF25Ji Firepaw.|r
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFF00FF25Jade Pillar|r
    .accept 29782 >>Accept Stronger Than Bone
step
    #completewith next
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFFDB2EEFFirework Bundles|r
...
step
    .goto 378,29.90,39.76
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Jojo Ironbrow|r
...
step
	...
	>>|TInterface/cursor/crosshair/interact.blp:20|tClick |cFFDB2EEFFirework Launchers|r when |cFFFF5722Zhao-Ren|r is over them to damage him. He circles counter-clockwise. |cFFFCDC00Avoid his Lightning puddles|r. Damage him when he lands. Kill him when he lands the second time
...
step
	...
	>>Kill |cFFFF5722Thornbranch Scamps|r and loot the |cFFDB2EEFCharms|r hanging from the trees.
...
step
    ...
    >>|TInterface/cursor/crosshair/interact.blp:20|tClick the |cFF00FF25Air Balloon|r to Board it
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Provisioner Drog|r
...
step
    ...
    >>Kill |cFFFF5722Pei-Wu Tigers|r. Loot the |cFFDB2EEFBamboo Stalks|r |cFFfa9602on the ground.|r
...
step
	...
	.mob Darkened Terror
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Makael Bay|r and |cFF00FF25Ji Firepaw|r
	...
	.target Ji Firepaw
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Delora Lionheart|r and |cFF00FF25Jojo Ironbrow|r
...
step
    .goto 378,42.27,86.80
    >>Carry the |cFF00FF25Injured Sailor|r back to |cFF00FF25Delora Lionheart|r's Camp
...
step
    ...
    >>Kill |cFFFF5722Vordraka, The Deep Sea Nightmare|r
...
step << Horde
    .goto 85,48.76,70.77
	>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cFF00FF25Garrosh Hellscream|r
