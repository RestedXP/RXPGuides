...
step << Dwarf
    ...
    #completewith next
    #label Crag Boars
    .goto 27,52.69,47.05,20,0
    .goto 27,52.5,43.17,20,0
    .goto 27,51.97,40.83,20,0
	...
	.mob Crag Boar
step << Dwarf
    #completewith Crag Boars
    .goto 27,51.2,40.78,20 >>Follow the Arrow killing and looting |cRXP_ENEMY_Crag Boars|r along the way.
step << Dwarf
    #requires Crag Boars
