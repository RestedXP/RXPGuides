...
addon.talents.RegisterGuide([[
#name Enhancement 10-70 Hardcore
#minLevel 10
#maxLevel 70
#order 2
...
level -- Guardian Totems (Rank 1)
    .talent 2,2,1,1

level -- Guardian Totems (Rank 2)
    .talent 2,2,1,2
...
level -- Toughness (Rank 2)
    .talent 2,4,3,2

level -- Toughness (Rank 3)
    .talent 2,4,3,3

level -- Toughness (Rank 4)
    .talent 2,4,3,4

level -- Toughness (Rank 5)
    .talent 2,4,3,5
