...
#completewith Scalding2
    >> If you were too slow and failed the timed quest, go and talk to |cRXP_FRIENDLY_ Nori Pridedrift|r
    .target Nori Pridedrift
    .goto Dun Morogh,25.0,76.0,0
    .accept 3364 >> Accept Scalding Mornbrew Delivery
    .goto Dun Morogh,28.8,66.4
...
>>Talk to |cRXP_FRIENDLY_ Muren Stormpike|r
...
>>Talk to |cRXP_FRIENDLY_ Tormus Deepforge|r
