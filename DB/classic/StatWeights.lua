...
addon.statWeights = {
    ['Warrior Hardcore'] = {
        ...
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_BASE'] = 14.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_2H_FAST'] = 50.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_MH_FAST'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_OH_FAST'] = 0.00,
        ['ITEM_MOD_HIT_RATING_SHORT'] = 22.00,
        ['ITEM_MOD_CRIT_RATING_SHORT'] = 10.50,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_RANGED'] = 1.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_RANGED_FAST'] = 7.00,
    ...
    ['Shaman Elemental Speedrun'] = {
        ...
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_BASE'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_2H_FAST'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_MH_FAST'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_OH_FAST'] = 0.00,
    ...
    ['Rogue Speedrun'] = {
        ...
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_BASE'] = 14.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_2H_FAST'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_MH_FAST'] = 60.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_OH_FAST'] = -40.00,
        ['ITEM_MOD_HIT_RATING_SHORT'] = 18.00,
        ['ITEM_MOD_CRIT_RATING_SHORT'] = 10.50,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_RANGED'] = 1.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_RANGED_FAST'] = 7.00,
    ...
    ['Hunter Speedrun'] = {
        ...
        ['ITEM_MOD_CRIT_SPELL_RATING_SHORT'] = 0.00,
        ['ITEM_MOD_ATTACK_POWER_SHORT'] = 1.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_BASE'] = 3.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_2H_FAST'] = 50.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_MH_FAST'] = 0.00,
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_OH_FAST'] = 0.00,
        ['ITEM_MOD_HIT_RATING_SHORT'] = 18.00,
        ...
        ['ITEM_MOD_DAMAGE_PER_SECOND_SHORT_RANGED_FAST'] = 100.00,
