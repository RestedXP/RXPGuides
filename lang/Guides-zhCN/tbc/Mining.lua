...
step
    ...
    >>购买 a 挖矿 Pick from Gorina next to Makaru
    .collect 2901,1 --Mining Pick (1)
    .skill mining,65,1
step
    #label Makaru
    .goto Orgrimmar,73.1,26.1
    .train 2575 >>Train Apprentice 挖矿 -75) from Makaru in the building in Orgrimmar
    .skill mining,65,1
step
    #requires Pick
    #completewith next
...
step
    .goto Orgrimmar,73.1,26.1
    .train 2576 >>Train Journeyman 挖矿 75-150) from Makaru in the building in Orgrimmar
    .skill mining,125,1
step
    #completewith next
...
step
    .skill mining,125 >>等级 your 挖矿 from 65-125 in The Barrens [Route 1]
...
step
    .goto Orgrimmar,73.1,26.1
    .train 3564 >>Train 导出 挖矿 150-225) from Makaru in the building in Orgrimmar
    .skill mining,175,1
step << Mage
    #completewith next
...
step << !Mage
    #completewith next
    .goto Durotar,45.5,12.2
    .zone Durotar >>离开奥格瑞玛 into Durotar. Alternatively, pay a mage for a 飞往幽暗城
    .skill mining,175,1
    .zoneskip Undercity
step << !Mage
    .goto Durotar,50.7,13.3,20,0
    .goto Durotar,50.8,13.9
    .zone Stranglethorn Vale >>登上飞艇塔 做飞艇去提瑞斯法林地 Glades
    .skill mining,175,1
    .zoneskip Undercity
step << !Mage
    .goto Undercity,66.3,4.4
    .zone Undercity >>飞往幽暗城, then take the elevators down
    .skill mining,175,1
...
step
    ...
    .skill mining,225,1
step
    .skill mining,225 >>等级 your 挖矿 from 175-225 in The Hinterlands
...
step
    .goto Orgrimmar,73.1,26.1
    .train 10248 >>Train Artisan 挖矿 225-300) from Makaru in the building in Orgrimmar
    .skill mining,245,1
step << Mage
    #completewith next
    .zone Shattrath City >>回城到沙塔斯，泰罗卡森林
    .skill mining,245,1
    .zoneskip Tanaris
    .reputation 989,revered,<0,1
step << Mage
    #completewith next
    .zone Tanaris >>与 Zephyr in the World's End Tavern to teleport to the Caverns of Time. Do NOT talk to the Steward of Time when you arrive
    .skill mining,245,1
    .skipgossip
    .reputation 989,revered,<0,1
step
...
step
    ...
    .skill mining,245 >>等级 your 挖矿 from 225-245 in Tanaris
...
step
    .skill mining,275 >>等级 your 挖矿 from 245-275 in Un'Goro Crater
...
step
    .skill mining,300 >>等级 your 挖矿 from 275-300 in Un'Goro Crater
...
step
    ...
    .skill mining,350,1
step
    .skill mining,350 >>等级 your 挖矿 from 325-63-64 泰罗卡森林
...
step
    #label Nagrand
    .skill mining,375 >>等级 your 挖矿 from 350-375 in Nagrand
...
step
    +Congratulations on reaching 375 挖矿 
]])
