...
step
    ...
    >>Loot the |cRXP_PICK_Shipment of Iron|r for the |T132761:0|t[|cRXP_LOOT_一箱铁材|r]
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_卡鲁斯|r 对话
    .bankdeposit 3692 >>Deposit your |T133730:0|t[|cRXP_LOOT_希尔斯布莱德人类颅骨|r] if you have them
    .bankdeposit 3564 >>Deposit |T132761:0|t[|cRXP_LOOT_一箱铁材|r]
    卡鲁斯
step << Paladin
    #optional
    .goto Orgrimmar,32.29,35.74
...
step
    #completewith next
    +|cRXP_WARN_Use your remaining|r |T134128:0|t[血岩碎片] |cRXP_WARN_to get buffs|r
...
step << Warrior
    ...
    >>|cRXP_WARN_NOTE: |T133027:0|t[颤抖的触角] 仅持续 15 分钟，完成此任务时不要离开或登出游戏|r
