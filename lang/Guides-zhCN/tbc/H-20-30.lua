...
step << Rogue/Hunter/Warrior/Shaman/Druid
    #optional
    #completewith FlytoXroads
    |cRXP_WARN_装备 |T132603:0|t[|cRXP_FRIENDLY_野狼护腕|r]|r
    .use 4794
    .itemcount 4794,1
    .itemStat 9,ITEM_MOD_ARMOR_SHORT,<37
    .equip 9,4794
...
step
    ...
    >>到达后点击 |cRXP_PICK_火盆|r
    >>|cRXP_WARN_There will be waves of|r |cRXP_ENEMY_Naga|r |cRXP_WARN_that spawn. Be careful once|r |cRXP_ENEMY_Vorsha|r |cRXP_WARN_comes out, he hits very hard|r
    >>|cRXP_WARN_在与他战斗之前，|cRXP_WARN_先让 |r|cRXP_FRIENDLY_穆格拉什（Muglash）|r 引怪！|r
...
step << Priest
    #optional
    .goto Orgrimmar,35.59,87.80
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to|r |cRXP_FRIENDLY_乌尔库|r 对话
    .train 3747 >>训练你的职业技能
    .target Ur'kyo
    .xp <24,1
step << Rogue
...
step
    ...
    >>|cRXP_WARN_Be careful.|r |cRXP_ENEMY_希尔斯布莱德农夫|r |cRXP_WARN_can|r |T132343:0|t[Disarm] |cRXP_WARN_你|r << Rogue/Warrior/Shaman/Paladin
...
step
	#completewith Fields2
    >>击杀 |cRXP_ENEMY_Gray Bears|r. Loot them for their |cRXP_LOOT_灰熊的舌头|r
	.complete 496,1 --Collect Gray Bear Tongue (x10)
    .mob Gray Bear
    .mob Vicious Gray Bear
    .isQuestTurnedIn 501
...
step << Hunter
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t|cRXP_BUY_Talk to|r |cRXP_FRIENDLY_基苏|r 对话
...
step << Shaman
    ...
    .turnin 1534 >>交任务《 前往熔光镇》 水之召唤
    .accept 220 >>接受任务《物归己用》 水之召唤
    .target Brine
step
...
step
    ...
    >>|cRXP_WARN_Be Careful!|r |cRXP_ENEMY_巴尔丹军官|r |cRXP_WARN_have a 50% increased parry chance for 8 seconds after they do their defense stance animation|r << Rogue/Warrior/Druid/Shaman/Paladin
...
step
    ...
    >>打开 |cRXP_PICK_General Twinbraid's Strongbox|r。并从中拾取 |cRXP_LOOT_Tear of the Moons|r
    >>|cRXP_WARN_Be careful! It is very easy overpull in |cRXP_ENEMY_双辫将军|r's room|r
    >>|cRXP_WARN_Directly pull any mob other than |cRXP_ENEMY_双辫将军|r << !Hunter !Warlock
    >>|cRXP_WARN_Directly pull any mob other than |cRXP_ENEMY_双辫将军|r and use your pet to tank. Alternatively send your pet in and loot the strongbox|r << Hunter/Warlock
...
step
    ...
    >>点击地上的 |cRXP_PICK_Bael Modan Flying Machine|r atop the platform
...
step
    ...
    >>点击 the |cRXP_FRIENDLY_Wanted Poster|r
...
step
    ...
    >>拾取散发绿光的 |cRXP_PICK_Incendia Agave Plants|r on the ground 和 对话
...
step
    ...
    >>点击地上的 |cRXP_PICK_塞拉摩卫兵徽章|r on the plank of wood on the ground
...
step
    ...
    >>点击地上的 |cRXP_PICK_Black Shield|r above the fireplace
...
step
    ...
    .subzone 496 >>前往暴风城大教堂内，与 Brackenwall Village
...
step
    ...
    >>打开 |cRXP_PICK_Document Chest|r on top of the plataeu. 拾取地上的 it for |cRXP_LOOT_Secret Note #1|r
    .complete 5064,1 --Secret Note #1 (1)
step
    .goto Thousand Needles,33.80,39.90
    >>打开 |cRXP_PICK_Document Chest|r 对话，NPC在里面 the big tent. 拾取地上的 it for |cRXP_LOOT_Secret Note #1|r
    .complete 5064,2 --Secret Note #2 (1)
step
    .goto Thousand Needles,39.20,41.60
    >>打开 |cRXP_PICK_Document Chest|r 对话，NPC在里面 the tent on the eastern plateau. 拾取地上的 it for |cRXP_LOOT_Secret Note #1|r
...
step
    ...
    .goto Tanaris,51.60,25.44,100 >>前往暴风城大教堂内，与 Gadgetzan
    .zoneskip Tanaris
step
...
step
    ...
    >>拾取地上的 |cRXP_PICK_Thermaplugg's Safe|r in the northern side of the room for the |cRXP_LOOT_Rig Blueprints|r
