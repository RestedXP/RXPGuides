...
step
    ...
    >>消灭那些试图阻止仪式的 it for the |cRXP_LOOT_First Key Fragment|r
...
step
    ...
    .use 30094 >>|cRXP_WARN_Use the|r |T135462:0|t[Totem of Spirits] |cRXP_WARN_and kill|r |cRXP_ENEMY_愤怒的水灵|r
    >>|cRXP_WARN_Ensure you kill them while they are beside the|r |T135462:0|t[Totem of Spirits]
...
step
    ...
    .use 30094 >>|cRXP_WARN_Use the|r |T135462:0|t[Totem of Spirits] |cRXP_WARN_and kill|r |cRXP_ENEMY_愤怒的气灵|r
    >>|cRXP_WARN_Ensure you kill them while they are beside the|r |T135462:0|t[Totem of Spirits]
...
step
    ...
    .use 30462 >>|cRXP_WARN_Stand on top of the small plants on the ground and use|r |T132161:0|t[Oronok's Boar Whistle] |cRXP_WARN_to have a nearby Domesticated Felboars dig out|r |cRXP_LOOT_影月块茎|r
...
step
    ...
    >>击杀 for the |cRXP_LOOT_Crystalline Key|r
...
step
    ...
    >>消灭那些试图阻止仪式的 them for |cRXP_LOOT_洛恩戈鲁，裂心之弓|r
...
step
    ...
    >>|cRXP_WARN_Head southeast while the |cRXP_FRIENDLY_阿托尔的灵魂|r follows you, walk around this area until he summons|r |cRXP_ENEMY_维内拉图斯|r
...
step
    .goto Shadowmoon Valley,48.959,57.495
    .use 30616 >>击杀 attackable.拾取地上的 him for the |cRXP_LOOT_怒风的信件|r
...
step
    #completewith next
    .cast 37236 >>|cRXP_WARN_Channel the|r |T134423:0|t[The Cipher of Damnation] |cRXP_WARN_for 20 seconds to summon|r |cRXP_ENEMY_火焰之王森卢肯|r
    .use 30657
step
...
step
    ...
    .target Soridormi
step
    >>击杀 for |cRXP_LOOT_Vashj's Vial Remnant|r
...
#aldor
    ...
    >>击杀 |cRXP_ENEMY_Oronu|r on the balcony
...
#aldor
    ...
    >>Destroy the totems protecting |cRXP_ENEMY_拉坎恩|r.击杀并拾取 him for his |cRXP_LOOT_勋章碎片|r
    .complete 10574,3 --Collect Lakaan's Medallion Fragment (x1)
	.mob Lakaan
step
#aldor
    .goto Shadowmoon Valley,48.289,39.564
    >>Destroy the totems protecting |cRXP_ENEMY_乌拉鲁|r.击杀并拾取 him for his |cRXP_LOOT_勋章碎片|r
    .complete 10574,4 --Collect Uylaru's Medallion Fragment (x1)
	.mob Uylaru
step
#aldor
    .goto Shadowmoon Valley,51.164,52.840
    >>Destroy the totems protecting |cRXP_ENEMY_埃肯尼|r.击杀并拾取 him for his |cRXP_LOOT_勋章碎片|r
...
step
    ...
    >>|cRXP_ENEMY_杉德拉斯|r |cRXP_WARN_patrols the rooftop upstairs|r
...
step
    ...
    >>|cRXP_FRIENDLY_阿卡玛|r |cRXP_WARN_is further inside Warden's Cage|r
