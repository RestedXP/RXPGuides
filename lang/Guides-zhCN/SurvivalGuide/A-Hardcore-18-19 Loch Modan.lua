...
step << Hunter
    ...
    .vendor >>|cRXP_BUY_购买|r |T134410:0|t[中型箭袋] |cRXP_BUY_和|r |T132382:0|t[经典怀旧服 道具]
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_镇长埃罗恩·钝鼻|r 对话
    .accept 255 >>接受任务 雇佣兵
...
step
    #completewith next
    +|cRXP_WARN_小心不要碰到|r |cRXP_ENEMY_部落 Runners|r|cRXP_WARN_！这是一个在洛克湖东侧巡逻的精英小队，由2个 |cRXP_ENEMY_Orcs|r 和一个 |cRXP_ENEMY_牛头人|r 组成(在你的地图上的那条线)|r
...
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_年轻的达瑞尔|r 对话
    .goto Loch Modan,83.49,65.40
...
step
    .group
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_维林·疾风|r 对话
...
step
    ...
    >>杀死 |cRXP_ENEMY_Loch Crocolisks|r。拾取它们的 |cRXP_LOOT_肉|r 和 |cRXP_LOOT_Skin|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_麦格玛尔·落斧|r 对话
...
step
    ...
    >>击杀 |cRXP_ENEMY_Stonesplinter Diggers|r、|cRXP_ENEMY_Stonesplinter Geomancers|r 和 |cRXP_ENEMY_Berserk Troggs|r，拾取它们的 |cRXP_LOOT_Idols|r
    .complete 297,1
...
step
    .group
    #completewith next
    .goto Loch Modan,41.21,64.33,100 >>前往 灰爪山
    .isOnQuest 271
step
    .group 3
    ...
    >>击杀 |cRXP_ENEMY_老黑炭|r。拾取他的 |cRXP_LOOT_头部|r
    >>|cRXP_ENEMY_老黑炭|r |cRXP_WARN_不总是在他的洞穴内，可能沿着通往下层地面的小路巡逻|r
...
step
    #completewith next
    .goto Loch Modan,82.92,59.37,80,0
    .goto Loch Modan,83.28,62.97,25 >>前往 旅行者营地
step
    .goto Loch Modan,81.76,61.66
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_马雷克·铁心|r 对话
    .turnin 385 >>交任务 Hunting Crocodiles
    .target Marek Ironheart
step
    .group
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_年轻的达瑞尔|r 对话
...
step
    .group 3
    >>击杀 |cRXP_ENEMY_Mo'grosh 莫加尔大王 <食人魔之王>|r、|cRXP_ENEMY_Mo'grosh Enforcers|r 和 |cRXP_ENEMY_Mo'grosh Brutes|r
    >>|cRXP_ENEMY_Mo'grosh Brutes|r |cRXP_WARN_只在洞穴内出现。不建议进入东北方的洞穴，只需在其他两个小洞穴中击杀它们|r
...
step
    #completewith next
    +|cRXP_WARN_小心不要遭遇|r Horde Runners|cRXP_ENEMY_！这是一个由2个|r Orcs|cRXP_WARN_ 和一个|cRXP_ENEMY_ |r牛头人|cRXP_ENEMY_ |r组成的精英小队，他们在洛克湖（地图上你的那条线）东侧巡逻|r
    .line Loch Modan,55.5,67.1,60.2,62.0,62.9,57.6,63.7,54.3,64.2,51.8,64.5,46.1,64.2,35.9,63.4,33.7,59.3,24.4,60.2,22.4,57.3,19.4
    .unitscan Haren Swifthoof
    .unitscan Gradok
    .unitscan Thragomm
...
step
    .goto Loch Modan,37.17,47.94,8,0
    .goto Loch Modan,37.24,47.38
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_吉恩·角盔|r 对话
...
step
    ...
    .goto Loch Modan,34.69,43.18
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_镇长埃罗恩·钝鼻|r 对话
    .turnin 255 >>交任务 [DEPRECATED] 雇佣兵
    .target Magistrate Bluntnose
    .isQuestComplete 255
step
    .group
    .abandon 255 >>放弃任务 [DEPRECATED] 雇佣兵
step
    #label FINISHED
    .goto Loch Modan,33.938,50.954
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|t与 |cRXP_FRIENDLY_Thorgrum|r 对话
    .fly Ironforge >>飞往铁炉堡
    .target 索格拉姆·伯雷森
step
