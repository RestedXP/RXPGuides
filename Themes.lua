...
addon.v2.themes['v2'] = {
    ...
    borderColors = {
        ...
        activePartyTab = {55 / 255, 62 / 255, 109 / 255, 1},
        inactivePartyTab = {62 / 255, 66 / 255, 102 / 255, 1},
        activeStepItem = {150 / 255, 156 / 255, 185 / 255, 1},
        activeStepBadge = {150 / 255, 156 / 255, 185 / 255, 1},
        activeStepCheckbox = {55 / 255, 62 / 255, 109 / 255, 1},
        activeStepCheckboxChecked = {17 / 255, 132 / 255, 1, 1},
    },
    ...
    layout = {
        ...
        activePartyStepItemMargin = {bottom = 8},
        activeStepElement = {
            checkboxSize = 11,
        ...
        partyContent = {left = 6, right = 6, top = 5, bottom = 14},
        partyFrame = {defaultWidth = 265, minWidth = 265, minHeight = 105},
        partyScrollbar = {scale = 0.75},
    },
    ...
    textColor = {
        ...
        activePartyTab = {24 / 255, 210 / 255, 255 / 255},
        inactivePartyTab = {0.62, 0.62, 0.72},
        activePartyStepItem = {1, 1, 1},
